            ...
            <div className="flex justify-between items-center w-full">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent>
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem onClick={() => setValue("")}>
                    Default
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setValue("Cowboy")}>
                    Cowboy 🤠
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setValue("Shakespeare")}>
                    Shakespeare 🎭
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setValue("Surfer")}>
                    Surfer 🏄‍♂️
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setValue("Gen Z")}>
                    Gen Z 🤳
                  </DropdownMenuItem>
                  <DropdownMenuItem onClick={() => setValue("Pirate")}>
                    Pirate 🏴‍☠️
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
                      ...
                      <img
                        ...
                        src={
                          message.avatarUrl || user
                            ...
                            : "https://pbs.twimg.com/profile_images/1719004662630580224/B9j_z9iG_400x400.jpg"
                        }
                      />
                    </div>
                    <div
